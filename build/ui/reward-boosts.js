...
function cardButton(options, action, disabled, fallback) {
...
function renderCoinCard(options) {
...
function renderGoldenCard(options) {
    const { adBoosts, t } = options;
...
function renderMutationCard(options) {
    const { adBoosts, t } = options;
...
function renderFreeUpgradeCard(options) {
    const { adBoosts, t } = options;
...
export function renderRewardBoostsPanel(options) {
    if (!options.rewardedAds)
        return '';
