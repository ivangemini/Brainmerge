...
function phaseOvergrowthIndexes(phase, locationId = SNEAKER_GARDEN_LOCATION_ID) {
...
function sanitizeOvergrowth(candidate, phase, locationId) {
...
function createLocationRun(phase, maxDiscoveredTier, worldId = 1, locationId = SNEAKER_GARDEN_LOCATION_ID) {
